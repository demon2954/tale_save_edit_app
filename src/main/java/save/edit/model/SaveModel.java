...
public class SaveModel {
    ...
    private String m_strPlayerLastName;
    private String m_PlayerIconID;
    private int m_iMoney;
    private String m_strModelName;
    private int m_fTalkRange;
    private double m_fStopRange;
    private double m_fWalkRange;
    private double m_fNowX;
    private double m_fNowY;
    private double m_fNowZ;
    private int m_iNowTime;
    private double m_fDir;
    private double m_fNowTime;
    ...
    private long m_iRoutineID;
    private List<M_PlayerRoutineNodeList> m_PlayerRoutineNodeList;
    private List<M_PlayerNeigongNodeList> m_PlayerNeigongNodeList;
    private int m_iNeigongID;
    private List<Long> m_DevelopQuestList;
    private List<M_LotusBtnIDList> m_LotusBtnIDList;
    private List<M_DevelopBtnStatusList> m_DevelopBtnStatusList;
    private List<M_YearCourdeNodeList> m_YearCourdeNodeList;
    private List<M_MartialIDList> m_MartialIDList;
    private List<M_AbilityIDList> m_AbilityIDList;
    private long m_iWeaponsID;
    private long m_iEquipID;
    private long m_iAccessoriesID;
    private List<M_NpcFriendlyNodeList> m_NpcFriendlyNodeList;
    private List<String> m_TreasureBoxIDList;
    private int m_iAutomaticIndex;
    private int m_iAutomaticDIndex;
    private List<M_StoreDataNodeList> m_StoreDataNodeList;
    private boolean m_bInOutSideHouse;
    private double m_fInSideAbLi_r;
    private double m_fInSideAbLi_g;
    private double m_fInSideAbLi_b;
    private int m_fInSideAbLi_a;
    private int m_iMusicIndex;
    private List<Long> m_teamMemberList;
    ...
    public void setM_iMoney(int m_iMoney) {
         this.m_iMoney = m_iMoney;
     }
     public int getM_iMoney() {
         return m_iMoney;
     }
    ...
    public void setM_fStopRange(double m_fStopRange) {
         this.m_fStopRange = m_fStopRange;
     }
     public double getM_fStopRange() {
         return m_fStopRange;
     }

    public void setM_fWalkRange(double m_fWalkRange) {
         this.m_fWalkRange = m_fWalkRange;
     }
     public double getM_fWalkRange() {
         return m_fWalkRange;
     }

    public void setM_fNowX(double m_fNowX) {
         this.m_fNowX = m_fNowX;
     }
     public double getM_fNowX() {
         return m_fNowX;
     }

    public void setM_fNowY(double m_fNowY) {
         this.m_fNowY = m_fNowY;
     }
     public double getM_fNowY() {
         return m_fNowY;
     }

    public void setM_fNowZ(double m_fNowZ) {
         this.m_fNowZ = m_fNowZ;
     }
     public double getM_fNowZ() {
         return m_fNowZ;
     }
    ...
    public void setM_fDir(double m_fDir) {
         this.m_fDir = m_fDir;
     }
     public double getM_fDir() {
         return m_fDir;
     }

    public void setM_fNowTime(double m_fNowTime) {
         this.m_fNowTime = m_fNowTime;
     }
     public double getM_fNowTime() {
         return m_fNowTime;
     }
    ...
    public void setM_PropertyGroupsNodeList(List<M_PropertyGroupsNodeList> m_PropertyGroupsNodeList) {
         this.m_PropertyGroupsNodeList = m_PropertyGroupsNodeList;
     }
     public List<M_PropertyGroupsNodeList> getM_PropertyGroupsNodeList() {
    ...
    public void setM_EventList(List<Long> m_EventList) {
         this.m_EventList = m_EventList;
     }
     public List<Long> getM_EventList() {
         return m_EventList;
     }
    ...
    public void setM_iRoutineID(long m_iRoutineID) {
         this.m_iRoutineID = m_iRoutineID;
     }
     public long getM_iRoutineID() {
         return m_iRoutineID;
     }

    public void setM_PlayerRoutineNodeList(List<M_PlayerRoutineNodeList> m_PlayerRoutineNodeList) {
         this.m_PlayerRoutineNodeList = m_PlayerRoutineNodeList;
     }
     public List<M_PlayerRoutineNodeList> getM_PlayerRoutineNodeList() {
         return m_PlayerRoutineNodeList;
     }

    public void setM_PlayerNeigongNodeList(List<M_PlayerNeigongNodeList> m_PlayerNeigongNodeList) {
         this.m_PlayerNeigongNodeList = m_PlayerNeigongNodeList;
     }
     public List<M_PlayerNeigongNodeList> getM_PlayerNeigongNodeList() {
    ...
    public void setM_DevelopQuestList(List<Long> m_DevelopQuestList) {
         this.m_DevelopQuestList = m_DevelopQuestList;
     }
     public List<Long> getM_DevelopQuestList() {
         return m_DevelopQuestList;
     }

    public void setM_LotusBtnIDList(List<M_LotusBtnIDList> m_LotusBtnIDList) {
         this.m_LotusBtnIDList = m_LotusBtnIDList;
     }
     public List<M_LotusBtnIDList> getM_LotusBtnIDList() {
         return m_LotusBtnIDList;
     }

    public void setM_DevelopBtnStatusList(List<M_DevelopBtnStatusList> m_DevelopBtnStatusList) {
         this.m_DevelopBtnStatusList = m_DevelopBtnStatusList;
     }
     public List<M_DevelopBtnStatusList> getM_DevelopBtnStatusList() {
         return m_DevelopBtnStatusList;
     }

    public void setM_YearCourdeNodeList(List<M_YearCourdeNodeList> m_YearCourdeNodeList) {
         this.m_YearCourdeNodeList = m_YearCourdeNodeList;
     }
     public List<M_YearCourdeNodeList> getM_YearCourdeNodeList() {
         return m_YearCourdeNodeList;
     }

    public void setM_MartialIDList(List<M_MartialIDList> m_MartialIDList) {
         this.m_MartialIDList = m_MartialIDList;
     }
     public List<M_MartialIDList> getM_MartialIDList() {
         return m_MartialIDList;
     }

    public void setM_AbilityIDList(List<M_AbilityIDList> m_AbilityIDList) {
         this.m_AbilityIDList = m_AbilityIDList;
     }
     public List<M_AbilityIDList> getM_AbilityIDList() {
         return m_AbilityIDList;
     }

    public void setM_iWeaponsID(long m_iWeaponsID) {
         this.m_iWeaponsID = m_iWeaponsID;
     }
     public long getM_iWeaponsID() {
         return m_iWeaponsID;
     }

    public void setM_iEquipID(long m_iEquipID) {
         this.m_iEquipID = m_iEquipID;
     }
     public long getM_iEquipID() {
         return m_iEquipID;
     }

    public void setM_iAccessoriesID(long m_iAccessoriesID) {
         this.m_iAccessoriesID = m_iAccessoriesID;
     }
     public long getM_iAccessoriesID() {
         return m_iAccessoriesID;
     }

    public void setM_NpcFriendlyNodeList(List<M_NpcFriendlyNodeList> m_NpcFriendlyNodeList) {
         this.m_NpcFriendlyNodeList = m_NpcFriendlyNodeList;
     }
     public List<M_NpcFriendlyNodeList> getM_NpcFriendlyNodeList() {
    ...
    public void setM_StoreDataNodeList(List<M_StoreDataNodeList> m_StoreDataNodeList) {
         this.m_StoreDataNodeList = m_StoreDataNodeList;
     }
     public List<M_StoreDataNodeList> getM_StoreDataNodeList() {
    ...
    public void setM_bInOutSideHouse(boolean m_bInOutSideHouse) {
     ...
     public boolean getM_bInOutSideHouse() {
         return m_bInOutSideHouse;
     }

    public void setM_fInSideAbLi_r(double m_fInSideAbLi_r) {
         this.m_fInSideAbLi_r = m_fInSideAbLi_r;
     }
     public double getM_fInSideAbLi_r() {
         return m_fInSideAbLi_r;
     }

    public void setM_fInSideAbLi_g(double m_fInSideAbLi_g) {
         this.m_fInSideAbLi_g = m_fInSideAbLi_g;
     }
     public double getM_fInSideAbLi_g() {
         return m_fInSideAbLi_g;
     }

    public void setM_fInSideAbLi_b(double m_fInSideAbLi_b) {
         this.m_fInSideAbLi_b = m_fInSideAbLi_b;
     }
     public double getM_fInSideAbLi_b() {
         return m_fInSideAbLi_b;
     }

    public void setM_fInSideAbLi_a(int m_fInSideAbLi_a) {
         this.m_fInSideAbLi_a = m_fInSideAbLi_a;
     }
     public int getM_fInSideAbLi_a() {
    ...
    public void setM_teamMemberList(List<Long> m_teamMemberList) {
         this.m_teamMemberList = m_teamMemberList;
     }
     public List<Long> getM_teamMemberList() {
