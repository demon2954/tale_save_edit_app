...
public class _ItemDataNode {
    ...
    private List<M_strNpcLike> m_strNpcLikeList;
    private List<M_UseLimitNode> m_UseLimitNodeList;
    ...
    public void setM_strNpcLikeList(List<M_strNpcLike> m_strNpcLikeList) {
         this.m_strNpcLikeList = m_strNpcLikeList;
     }
     public List<M_strNpcLike> getM_strNpcLikeList() {
         return m_strNpcLikeList;
     }

    public void setM_UseLimitNodeList(List<M_UseLimitNode> m_UseLimitNodeList) {
         this.m_UseLimitNodeList = m_UseLimitNodeList;
     }
     public List<M_UseLimitNode> getM_UseLimitNodeList() {
         return m_UseLimitNodeList;
     }

    public void setM_ItmeEffectNodeList(List<M_ItmeEffectNodeList> m_ItmeEffectNodeList) {
         this.m_ItmeEffectNodeList = m_ItmeEffectNodeList;
     }
     public List<M_ItmeEffectNodeList> getM_ItmeEffectNodeList() {
